...
# Create the start_game function. done
# Write your code inside this function. done
...
#   4. Once the guess is correct, stop looping, inform the user they "Got it" and store the number of guesses it took in a list. done
        
#   5. Display the following data to the player done
...
#   6. Prompt the player to play again done
...
# Kick off the program by calling the start_game function. done
